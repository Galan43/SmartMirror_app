...
import 'package:mqtt_demo/pages/config_page.dart';
import 'package:mqtt_demo/pages/forgotpassword_page.dart';
...
Future<void> signInWithEmailAndPassword(
  ...
  try {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ConfigPage(key: UniqueKey())),
    );
  } on FirebaseAuthException catch (e) {
    ...
    return Container(
      decoration:const BoxDecoration(
        gradient: LinearGradient(
          colors: [
            Color(0xFF73726f), // Cambio aquí - Azul claro
            Color(0xFF73726f), // Cambio aquí - Azul
          ],
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Logo(), // Agregamos el widget Logo aquí
          const Text(
            'Login',
            style: TextStyle(
          ...
          child: ElevatedButton(
            ...
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(
                const Color(0xFF1082e0), // Cambio aquí - Gris
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Container(
            width: 150.0, // Tamaño del círculo
            height: 150.0,
            decoration: const BoxDecoration(
